...
@section('route-list')
    ...
    <li class="breadcrumb-item"><a href="{{route('admin.create')}}"> إضافة مشرف</a></li>
@endsection
        ...
        <div class="card-body text-center">
         <form action="{{route('admin.store')}}" method="post">
            ...
            <div class="input-group mb-4">
                ...
                <input id="adminPhone" name="phone" type="text" class="form-control" placeholder="الجوال" required>
                @error('phone')
                <div class="alert alert-danger error_mes">{{ $message }}</div>
                @enderror
            </div>
